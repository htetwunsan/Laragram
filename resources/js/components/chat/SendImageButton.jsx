...
export default function SendImageButton({ postImageMessage }) {
    ...
    return (
        <button className="flex items-center justify-center p-2" style={{ height: '42px' }} type="button" onClick={handleClick}>
            <input ref={inputImageRef} className="hidden" type="file" accept="image/*" onChange={handleChange} />
            <svg aria-label="Add Photo or Video" color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">

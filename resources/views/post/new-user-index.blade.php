    ...
    <section id="section_main" class="h-full flex flex-col items-stretch overflow-y-auto no-scrollbar">
        <x-app-top-navigation>
            <x-slot name="left">
                <div class="flex flex-row items-stretch justify-start w-8">
                    <button type="button">
                        <svg aria-label="New Story" class="text-triple38 fill-current w-6 h-6" role="img"
                            viewBox="0 0 48 48">
            ...
            <a href="/" tabindex="0">
                <h1 class="font-cookie font-semibold text-3xl text-triple38 tracking-wider">{{ config('app.name',
                    'Laragram') }}</h1>
            </a>

            <x-slot name="right">
                <div class="flex flex-row items-stretch justify-end w-8">
                    <a aria-label="Direct messaging" href="{{ route('chat.index') }}" tabindex="0">
        ...
        <main class="bg-triple250 flex-grow flex flex-col items-stretch" role="main">
            <div class="flex flex-col items-stretch justify-center px-8 py-6 mt-2">
                <h2 class="text-triple38 text-center font-light -my-1" style="font-size: 22px; line-height: 26px;">
                    Welcome
            ...
            <div class="flex flex-col items-stretch relative">
                <div id="div_carousel"
                    ...
                    <div class="div_user bg-white flex flex-col items-stretch flex-none w-64 h-64 my-1 rounded-3xl"
                        style="scroll-snap-align: center; width: 236px; height: 344px;" role="button"
                        ...
                        <div class="flex-grow flex flex-col items-center p-4 rounded-3xl relative"
                            ...
                            <div class="absolute right-0 top-4 m-1">
                                <button class="btn_close p-2" type="button">
                                    <svg aria-label="Dismiss" class="text-triple142 fill-current" height="11" role="img"
                                        viewBox="0 0 48 48" width="11">
                                        <path clip-rule="evenodd"
                            ...
                            <span class="block bg-triple250 border border-solid border-triple219 rounded-full mb-2"
                                role="link" tabindex="-1" style="width: 88px; height: 88px;">
                            ...
                            <div class="flex flex-col items-stretch justify-center" style="height: 133px">
                                @if($user->postImages->count() <= 0) <div
                                    class="flex items-center justify-center py-2 gap-x-2">
                                    <div
                        ...
                        <div class="w-full flex flex-col items-stretch">
                            <button
                                ...
                                style="padding: 5px 9px;" type="button">
                                <span>Follow</span>
            ...
            <button id="btn_previous" class="absolute left-0 px-2 py-4 z-10" style="top: 170px" type="button"
                tabindex="-1">
                <span class="block previous-chevron"></span>
            </button>
            <button id="btn_next" class="absolute right-0 px-2 py-4 z-10" style="top: 170px;" type="button"
                tabindex="-1">

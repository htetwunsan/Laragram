<x-base-layout>
    <section id="section_main" class="h-full flex flex-col items-stretch overflow-y-auto">
        <form id="form_post_create" class="flex flex-col items-stretch" enctype="multipart/form-data"
            ...
            @csrf
            <input id="input_post_image" class="hidden" type="file" accept="image/*"
                   name="post_image"/>
            ...
            <x-app-top-navigation>
                ...
                <h1 class="first_step flex-1 text-base text-triple38 text-center font-semibold leading-18px whitespace-nowrap overflow-ellipsis">
                    New Post</h1>
                <h1 class="second_step flex-1 text-base text-triple38 text-center font-semibold leading-18px whitespace-nowrap overflow-ellipsis hidden">
                    Advanced Settings</h1>
                <h1 class="third_step flex-1 text-base text-triple38 text-center font-semibold leading-18px whitespace-nowrap overflow-ellipsis hidden">
                    Alt Text</h1>
            ...
            <main class="bg-triple250 bg-opacity-65 flex-grow flex flex-col items-stretch" role="main">
                ...
                <div class="third_step flex p-4 hidden">
                    ...
                    <div class="flex flex-col items-stretch">
                        <textarea
                            id="textarea_alt_text"
                            class="h-12 text-sm text-triple38 break-words leading-18px resize-none border-none focus:outline-none focus:ring-0 p-0.5"
                            aria-label="Write alt text…"
    ...
    <div
        id="div_overlay"
        class="bg-black bg-opacity-65 fixed inset-0 z-10 hidden">
    </div>
    @once
        @push('scripts')
            <script>

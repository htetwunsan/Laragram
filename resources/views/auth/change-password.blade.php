<x-base-layout>
    <section id="section_main" class="h-full flex flex-col items-stretch overflow-y-auto no-scrollbar">
        ...
        <x-app-top-navigation>
            ...
            <h1
                class="flex-1 text-base text-triple38 text-center font-semibold leading-18px whitespace-nowrap overflow-ellipsis">
                Change Password</h1>
                ...
                <article class="flex flex-col items-stretch">
                    <div class="flex flex-row items-stretch justify-start mt-5">
                        ...
                        <div class="flex flex-col items-stretch mr-5">
                            <h1 class="text-2xl text-triple38 text-left font-normal mb-0.5" style="line-height: 38px">{{
                            ...
                            <div class="flex flex-col items-stretch justify-start px-5">
                                <div class="flex flex-col items-stretch">
                                    <input
                                        ...
                                        aria-required="true" id="input_old_password" autocomplete="current-password"
                        ...
                        <div class="flex flex-col items-stretch mb-2">
                            ...
                            <div class="flex flex-col items-stretch justify-start px-5">
                                <div class="flex flex-col items-stretch">
                                    <input
                                        class="text-base text-triple38 font-normal tracking-normal leading-18px h-8 border border-solid border-triple219 rounded px-2.5"
                                        aria-required="true" id="input_new_password" autocomplete="new-password"
                        ...
                        <div class="flex flex-col items-stretch mb-2">
                            ...
                            <div class="flex flex-col items-stretch justify-start px-5">
                                <div class="flex flex-col items-stretch">
                                    <input
                                        class="text-base text-triple38 font-normal tracking-normal leading-18px h-8 border border-solid border-triple219 rounded px-2.5"
                                        aria-required="true" id="input_confirm_new_password" type="password"
